...
help:
	...
	@echo "  make check-prereqs     - Check for required tools (git, ruby, bundle)"
...
check-prereqs:
	...
	@command -v ruby >/dev/null 2>&1 || { echo "❌ ruby is required but not installed. Visit https://ruby-lang.org"; exit 1; }
